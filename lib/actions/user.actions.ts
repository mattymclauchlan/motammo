...
console.log("Creating processor token with request:", request);
...
export const getBank = async ({ documentId }: getBankProps) => {
  try {
    ...
    console.log("Bank retrieved:", bank);
...
export const getBankByAccountId = async ({ accountId }: getBankByAccountIdProps) => {
  try {
    ...
    console.log("Bank retrieved by accountId:", bank);

    if (bank.total !== 1) {
      console.log("No bank found for accountId:", accountId);
      return null;
    }
